...
void fcn3_3(int* n, double* x, double* fvec, double* fjac, int* ldfjac, int* iflag)
{
	...
	// Jacobi matrix J(x)
		...
		fjac[2] = -1.0 * cos(x[0]);			fjac[5] = 0.0;			fjac[8] = 1.0;
...
void practice3_3(void) {
	...
	printf("============ x(0) = (0.0, 0.0, 0.0) =========== \n");
	fprintf(fp_w, "============ x(0) = (0.0, 0.0, 0.0) =========== \n");
	...
	printf("============ x(0) = (1.55, 1.39, 1.10) =========== \n");
	fprintf(fp_w, "============ x(0) = (1.55, 1.39, 1.10) =========== \n");
